...
public class ThymeleafController {
    @GetMapping("show")//thymeleaf를 사용해서 template로 이동함
    public String showView(Model model){
        Member member = new com.example.ThymeleafSample.entity.Member(1,"회원81");
        Member member1 = new com.example.ThymeleafSample.entity.Member(10,"홍길동");
        Member member2 = new com.example.ThymeleafSample.entity.Member(20,"이영희");
